...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ChoreCore.Android.dll" comes first in this list. */
		"ChoreCore.Android.dll",
		"ChoreCore.Controllers.dll",
		"ChoreCore.dll",
		"ChoreCore.Managers.dll",
		...
		"ChoreCore.Models.dll",
		"ChoreCore.ViewModels.dll",
	};
